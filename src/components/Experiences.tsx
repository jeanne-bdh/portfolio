                        ...
                        <div className="mx-auto lg:w-2/5 md:w-1/2 md:pr-10 md:py-6">
                            <div className="flex relative pb-12">
                                ...
                                <div className="flex-grow pl-4">
                                    <h2 className="font-medium title-font text-sm text-gray-900 mb-1 tracking-wider">Octobre 2025</h2>
                            ...
                            <div className="flex relative pb-12">
                                ...
                                <div className="flex-grow pl-4">
                                    <h2 className="font-medium title-font text-sm text-gray-900 mb-1 tracking-wider">2024</h2>
                            ...
                            <div className="flex relative pb-12">
                                ...
                                <div className="flex-grow pl-4">
                                    <h2 className="font-medium title-font text-sm text-gray-900 mb-1 tracking-wider">2012 - 2024</h2>
                            ...
                            <div className="flex relative pb-12">
                                ...
                                <div className="flex-grow pl-4">
                                    <h2 className="font-medium title-font text-sm text-gray-900 mb-1 tracking-wider">2016</h2>
                            ...
                            <div className="flex relative">
                                ...
                                <div className="flex-grow pl-4">
                                    <h2 className="font-medium title-font text-sm text-gray-900 mb-1 tracking-wider">2010</h2>
